...
const provenance = validateProvenanceRepositoryFile({ root: ROOT, expectedNoteCount: 186 });
if (!provenance.ok) {
...
check(`论文库 papers/index.html ${(papersIndexSize / 1024).toFixed(0)}KB < 280KB`, () => papersIndexSize < 280 * 1024 || `超预算: ${(papersIndexSize / 1024).toFixed(0)}KB`);
