...
export const DATA_API_CONTRACT = Object.freeze({
  ...
  versioned_provenance_endpoint: "/data/v2/provenance.json",
  envelope_fields: Object.freeze(["schema_version", "content_commit", "generated_at", "data"]),
  index_data_fields: Object.freeze(["papers_endpoint", "legacy_endpoint", "deprecation", "license", "provenance"]),
  deprecation_fields: Object.freeze(["status", "removal_version"]),
  license_fields: Object.freeze(["policy_id", "asset_classes", "document", "notice"]),
  license_asset_class_fields: Object.freeze([
    "id", "license_expression", "reference_url", "project_license_declared", "provenance_fields",
  ]),
  provenance_reference_fields: Object.freeze(["policy_id", "schema_version", "endpoint", "policy"]),
...
export const DATA_API_FIELD_DICTIONARY = Object.freeze({
  ...
  data: field({
    ...
    consumers: ["data-api-v2", "browser-data-adapter"],
    migration: "papers data preserves legacy fields/order; the pre-v1.3 index contract adds reviewed license/provenance discovery without changing paper records",
  }),
  "data[].slug": field({
    type: "string",
    nullable: false,
  ...
  "data.license": field({
    type: "license-governance-reference",
    nullable: false,
    defaultValue: NO_DEFAULT,
    source: "EAI-LICENSE-MAP-1.0.0 governance policy",
    consumers: ["data-api-v2", "license-governance-check"],
    migration: "add before the first v1.3 publication; preserve the legacy manifest license string as a compatibility alias",
  }),
  "data.license.policy_id": field({
    type: "stable-policy-id",
    nullable: false,
    defaultValue: NO_DEFAULT,
    source: "license governance contract",
    consumers: ["data-api-v2", "license-governance-check"],
    migration: "bind the exact EAI-LICENSE-MAP-1.0.0 policy identifier",
  }),
  "data.license.asset_classes": field({
    type: "array<license-asset-class>",
    nullable: false,
    defaultValue: NO_DEFAULT,
    source: "license governance contract",
    consumers: ["data-api-v2", "license-governance-check"],
    migration: "emit the four ordered project/third-party asset classes exactly once",
  }),
  "data.license.asset_classes[].id": field({
    type: "stable-asset-class-id",
    nullable: false,
    defaultValue: NO_DEFAULT,
    source: "license governance contract",
    consumers: ["data-api-v2", "license-governance-check"],
    migration: "do not infer a class from file extension or generated-asset kind alone",
  }),
  "data.license.asset_classes[].license_expression": field({
    type: "SPDX-expression-or-NOASSERTION",
    nullable: false,
    defaultValue: NO_DEFAULT,
    source: "license governance contract",
    consumers: ["data-api-v2", "license-governance-check"],
    migration: "use MIT, CC-BY-4.0, or NOASSERTION exactly; NOASSERTION is not a grant",
  }),
  "data.license.asset_classes[].reference_url": field({
    type: "credential-free-https-url",
    nullable: false,
    defaultValue: NO_DEFAULT,
    source: "official license or SPDX semantics reference",
    consumers: ["data-api-v2", "license-governance-check"],
    migration: "link each stable expression to its authoritative public definition",
  }),
  "data.license.asset_classes[].project_license_declared": field({
    type: "boolean",
    nullable: false,
    defaultValue: NO_DEFAULT,
    source: "license governance contract",
    consumers: ["data-api-v2", "license-governance-check"],
    migration: "false for third-party material so project licenses cannot be inherited",
  }),
  "data.license.asset_classes[].provenance_fields": field({
    type: "array<provenance-field-name>",
    nullable: false,
    defaultValue: EMPTY_ARRAY_DEFAULT,
    source: "provenance v2 field dictionary",
    consumers: ["data-api-v2", "license-governance-check"],
    migration: "bind rights scopes to existing provenance fields without adding license claims to note records",
  }),
  "data.license.document": field({
    type: "site-base-aware-url",
    nullable: false,
    defaultValue: NO_DEFAULT,
    source: "public governance document route",
    consumers: ["data-api-v2", "license-governance-check"],
    migration: "publish the byte-identical root LICENSE text under /governance/",
  }),
  "data.license.notice": field({
    type: "site-base-aware-url",
    nullable: false,
    defaultValue: NO_DEFAULT,
    source: "public governance document route",
    consumers: ["data-api-v2", "license-governance-check"],
    migration: "publish the project rights notice under /governance/",
  }),
  "data.provenance": field({
    type: "provenance-governance-reference",
    nullable: false,
    defaultValue: NO_DEFAULT,
    source: "EAI-PROVENANCE-2.0.0 governance policy",
    consumers: ["data-api-v2", "service-worker-v2", "license-governance-check"],
    migration: "discover the canonical manifest byte copy and its human-readable policy",
  }),
  "data.provenance.policy_id": field({
    type: "stable-policy-id",
    nullable: false,
    defaultValue: NO_DEFAULT,
    source: "provenance governance contract",
    consumers: ["data-api-v2", "license-governance-check"],
    migration: "bind the exact EAI-PROVENANCE-2.0.0 policy identifier",
  }),
  "data.provenance.schema_version": field({
    type: "semver-string",
    nullable: false,
    defaultValue: NO_DEFAULT,
    source: "canonical provenance schema constant",
    consumers: ["data-api-v2", "service-worker-v2", "license-governance-check"],
    migration: "match the canonical provenance document exact version",
  }),
  "data.provenance.endpoint": field({
    type: "site-base-aware-url",
    nullable: false,
    defaultValue: NO_DEFAULT,
    source: "public canonical provenance byte-copy route",
    consumers: ["data-api-v2", "service-worker-v2", "license-governance-check"],
    migration: "point to /data/v2/provenance.json through existing base-path rules",
  }),
  "data.provenance.policy": field({
    type: "site-base-aware-url",
    nullable: false,
    defaultValue: NO_DEFAULT,
    source: "public governance document route",
    consumers: ["data-api-v2", "license-governance-check"],
    migration: "publish the process-only provenance policy under /governance/",
  }),
});
