---
title: "30-day core path + optional extension — 零基础上手具身 AI"
order: 5
intro: "如果你刚来，156 篇太多。这页先给你 30 天核心路径（25 篇论文 + 5 个复习/输出日），任务驱动读者再选做 5 天扩展。"
---

> **三条入口怎么选？** 本页是**30 天核心 + 5 天可选任务扩展**（适合每天固定投入）；[22 章导读](/guide/) 是**系统教材**（适合想搞懂原理再读论文）；[主题入门三连](/topics/) 是**按兴趣跳读**（适合已有方向）。三者内容互通，选一条主线即可，不必都走。Day 31–35 不计入 30 天核心进度。

> **想边走边勾选？** 打开 [可勾选的 30 天核心 Syllabus](/syllabus/)，Day 1–30 的完成度会保存在当前浏览器；可选扩展仍按本页继续。
...
这是任务驱动读者的补全段——每天 2 篇，完成后 13 篇任务论文就全部走完（对照 [research-task.md](https://github.com/estelledc/embodied-ai-reading-station/blob/main/research-task.md)）。如果你只想系统入门，可以先停在 Day 30。
