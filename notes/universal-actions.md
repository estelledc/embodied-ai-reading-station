...
本篇适合接在 [Ch12: OpenVLA / VLAs / MLA](../guide/ch12-openvla-vlas-mla.md) 后，也可以和 [Ch10: Datasets & Benchmarks](../guide/ch10-datasets-benchmarks.md) 交叉读。Ch12 解释 VLA 怎么输出动作，Ch10 解释数据集为什么重要；UniAct 把这两件事连起来：数据集越多，越需要统一动作表示。
