...
本篇主要对接 [Ch02: Planning](../guide/ch02-planning.md) 和 [Ch12: OpenVLA / VLAs / MLA](../guide/ch12-openvla-vlas-mla.md)。如果你只读 Ch12，可能会以为 VLA 就是“图像+指令 -> 动作”。LoHoVLA 说明，一旦任务变长，中间目标就会重新变重要。
