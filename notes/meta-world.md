...
给"会学习如何学习"的机器人算法搭一套"50 道考题"，用来量它们到底学没学会"举一反三"。
...
想象学校里有一群被吹得很神的"超级学生"，老师说："这些孩子学一个新东西特别快，做几道例题就能上手新章节！"

但你仔细一看，他们的"新章节"其实只是把"用 5 m/s 跑步"换成"用 6 m/s 跑步"——**说是新题，其实就是同一道题改了个数字**。这能叫举一反三吗？

机器人强化学习圈在 2019 年前后就是这种情况：

- 大家都说自己的"元学习算法"能让机器人快速学会新技能。
- 但大家用的"考题"都是窄到不能再窄的小变化——同一个机器人朝不同方向跑、不同速度跑。
- 在这种考题上拿了高分，到底说明算法学到了"通用的学习能力"，还是只学会了"换个数字"？没人知道。

Meta-World 想做的事，就是**把这群学生拉到一个真正像样的考场里考一次**：50 道完全不同的机械臂操作题（按按钮、开抽屉、扣篮、敲钉子……），看你还吹不吹得动。
