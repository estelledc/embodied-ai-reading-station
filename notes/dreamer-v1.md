...
让一个 AI 自己在脑子里"做白日梦"模拟未来，靠想象出来的画面学会跑步、翻跟头这些复杂动作。
...
想象你在学打网球。教练让你反复跟真人对打、挨球，几千次以后你会挥拍了——这是**"试错型"学习**，慢、累、还容易受伤。

另一种学法是：你看了几次教练示范，回家闭着眼睛**在脑子里反复模拟**——"球这样飞过来，我侧身，引拍，挥拍，球弹到对面那个角"。脑子里来回过 100 遍以后再上场，你会发现真的进步了。

这种"脑内模拟"在心理学里叫**心象演练（mental rehearsal）**，运动员普遍在用。问题是：**机器人能不能也学会"做梦"练习？**

机器人面临的版本是：

- 真实世界训练机器人很贵（机械臂磨损、人工标注、出 bug 砸坏东西）。
- 一只机器狗摔一千次才学会走，电池都换坏了。
- 如果 AI 能在自己脑子里"想象一千次摔跤"再上场，是不是就可以省下 99% 的真实试错？

Dreamer 要做的就是这件事：**让 AI 学一个"世界的脑内模型"，然后只在这个模型里做梦练习，不再天天跑去真环境碰运气**。
