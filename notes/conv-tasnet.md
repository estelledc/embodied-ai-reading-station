...
把两个人同时讲话的录音直接交给一个全卷积网络，它能把每个人的声音分别还原出来，比传统"看频谱图"的做法更准、更快、更小。
...
想象你在咖啡馆录了一段对话：你和朋友两个人同时讲话，麦克风录下来的就是一团混音。你后来想做后期，希望软件能"把朋友的声音单独抽出来"。

这个问题在学术上叫 **鸡尾酒会问题（cocktail party problem）**——人耳能轻松做到（注意力一聚焦就能听清某个人的声音），但机器一直做不好。

更具体一点的应用场景：

- **助听器**：老人在饭店听不清家人讲话，因为周围人声太多。如果助听器能实时把"想听的那个人"的声音抽出来，就能解决问题。
- **电话会议**：两个人同时插话时，对方听到的是一团糊。
- **语音识别前置**：让 Siri / 小爱听清你在说什么，前提是先把背景人声去掉。

这些场景共通的硬约束是：**实时 + 低延迟 + 能跑在小芯片上**。如果模型要好几秒才出结果，或者要塞进一台 GPU 服务器，助听器就永远做不出来。
...
**别再绕频谱图了——直接让网络自己学一种"适合分离"的表示，从原始波形进、原始波形出。**
