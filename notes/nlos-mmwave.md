...
不直接猜"东西在哪"，而是先猜"东西的表面朝哪个方向"，雷达就能隔着纸箱看清里面是个什么形状。
...
想象你网购到一个还没拆的快递盒。你想知道里面那把电钻有没有装反、把手朝哪边。

- 摄像头不行：盒子是不透明的。
- 把它拆了再合上太麻烦。
- X 光机：又贵，又对人有害。

那有没有一种"既便宜，又能穿过纸壳，还安全"的办法？有的——**毫米波雷达**。

> **毫米波雷达（mmWave Radar）**：发射一种波长几毫米的电磁波（频率 77 GHz 上下）。和蝙蝠靠超声波回声判断前方有没有墙是同一个套路，只不过这次用的是电磁波。它能穿过纸板、布、薄塑料这些遮挡物。

所以这篇论文的目标就是：**给机器人一台便宜的毫米波雷达，让它在不打开盒子的情况下，看清盒子里面那件东西的形状**。

应用场景举例：

- 仓库里的机械臂：闭着眼伸手进盒子里抓螺丝刀。
- 扫地机器人：知道沙发底下有没有袜子。
- AR 眼镜：让你"看穿"被布盖住的东西。
- 安检：比 X 光机便宜、比 X 光更安全。
...
**不去问"哪里有东西"，而是去问"东西的表面朝哪个方向"**。

把"找东西的位置"翻译成"估东西的朝向"，剩下的几何问题就好办了。
