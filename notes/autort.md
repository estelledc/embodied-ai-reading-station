...
本篇适合放在 [Ch10: Datasets & Benchmarks](../guide/ch10-datasets-benchmarks.md) 和 [Ch02: Planning](../guide/ch02-planning.md) 之间读。Ch10 告诉你数据集为什么重要，AutoRT 告诉你真实数据可以怎样被大模型主动采出来；Ch02 讲 LLM 规划，AutoRT 展示 LLM 在真实采集系统里的调度用法。
