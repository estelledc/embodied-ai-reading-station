...
让一种叫"毫米波雷达"的设备，**不用提前给它见过这个动作**，也能猜出"这个人在做什么"。
...
- 家里独居老人，半夜起来上厕所，可能摔倒
- 你想第一时间知道——但你**不能**装摄像头（隐私问题：谁愿意卧室被拍？）
- 灯也是关的，普通相机也看不清

有一种东西叫**毫米波雷达**：

> **毫米波雷达（mmWave radar）**：一种能发出非常短的电波的小盒子，电波撞到人身上反弹回来，它就能算出你在动什么。汽车前保险杠里就有，几十块到几百块一个。

它的好处：

- **看不见脸**：只能感知"这里有个东西在动"，不会拍到长相
- **不怕黑**：电波不靠光，黑天白天一样
- **穿衣服没事**：电波能穿过薄布料

但有个**致命问题**：

- 想训练它"认出 100 种动作"，可是收集数据**特别费劲**
- 这篇论文为了凑 6 小时真实数据，找了 8 个人配合好几天
- 一旦换一个新动作（比如"老人扶腰站起来"），它就完全抓瞎
...
**核心点子**：把每个动作**拆成 5 个方面**来描述（比如躯干、手臂、腿、位置变化等），让模型学会"动作之间共享的零件"，新动作就能靠"零件组合"猜出来。

类比：

- 旧方法：把"喝水"和"拿东西"当作两件完全无关的事
- mmCLIP：把它们都拆成"手臂动 + 躯干不动 + 腿不动 + ..."——一拆开发现两者**手臂部分几乎一样**
