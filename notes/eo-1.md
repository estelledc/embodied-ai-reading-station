...
本篇对接 [Ch12: OpenVLA / VLAs / MLA](../guide/ch12-openvla-vlas-mla.md)、[Ch10: Datasets & Benchmarks](../guide/ch10-datasets-benchmarks.md) 和 [Ch06: World Models](../guide/ch06-world-models.md)。它既是 VLA 架构论文，也是数据范式论文，还带有世界状态推理色彩。
