...
让助听器自己就能听清吵闹环境里对面那个人说话，不用连手机、不用连云。
...
想象你 70 岁的爷爷戴着助听器去咖啡馆。

旁边桌的人聊天、咖啡机蒸汽、背景音乐，全都叠在一起冲进他耳朵。他听对面孙子说话只能靠猜。

![戴在耳后的样子](../papers/neuralaids/images/img_001.jpg)

现在市面上"AI 助听器"主要有两种做法：

1. 把麦克风的声音偷偷传到手机上，让手机算完再传回来。问题是：网络一抖、信号一断，回声就乱了。
2. 在助听器自己里面跑一个超级简化的小程序。问题是：噪音确实小了，但你孙子的声音也变得像水里说话。
...
- **小**：助听器电池只有几百毫安时（mAh，电量单位），相当于一节小电池。
- **快**：声音从耳朵进、被处理完、再播给你听，整个过程必须在 10 毫秒（千分之一秒）以内。慢一点你就会觉得"自己说话像在山洞里"。
