                                         ...
                                         D REAM TO C ONTROL : L EARNING B EHAVIORS
                                         BY L ATENT I MAGINATION
...
arXiv:1912.01603v3 [cs.LG] 17 Mar 2020
                                         ...
                                         1       I NTRODUCTION
                                         Intelligent agents can achieve goals in complex environments even though            Dataset of Experience
                                         ...
                                         models can abstract observations to predict forward in compact state spaces        Learned Latent Dynamics
                                         ...
                                         within a fixed imagination horizon results in shortsighted behaviors (Wang          by Latent Imagination
                                         ...
                                         for rewards beyond the imagination horizon while making efficient use of          Figure 1: Dreamer
                                         ...
                                         Bellman consistency for imagined rewards and the policy maximizes the             and efficiently learns
                                         ...
                                         Haarnoja et al., 2018; Lee et al., 2019), world models can interpolate past       estimates back through
                                         experience and offer analytic gradients of multi-step returns for efficient       imagined trajectories.
                                         policy optimization.
                                             ∗
...
2    C ONTROL WITH W ORLD M ODELS
...
p(ot , rt | o<t , a<t ) generated by the unknown
                                              PT   environment. The goal is to develop an agent that
                                                        
maximizes the expected sum of rewards Ep          t=1 rt . Figure 2 shows a selection of our tasks.
...
Published as a conference paper at ICLR 2020
          ...
          ̂r1         a1        ̂r2         a2        ̂r3         v̂ 1   ̂r1   â 1       v̂ 2   ̂r2   â 2    v̂ 3   ̂r3   â 3          a1        a2        â 3




     o1         ̂o1        o2         ̂o2        o3         ̂o3          o1                                                          o1        o2        o3
...
3     L EARNING B EHAVIORS BY L ATENT I MAGINATION
...
sτ ∼ q(sτ | sτ −1 , aτ −1 ), reward model rτ ∼ q(rτ | sP      τ ), and a policy aτ ∼ q(aτ | sτ ). The
                                                                 ∞      τ −t
objective is to maximize expected imagined rewards Eq            τ =t γ      rτ with respect to the policy.
...
while not converged do                                                                                        Transition     qθ (st | st-1 , at-1 )
     for update step c = 1..C do                                                                              Reward         qθ (rt | st )
            ...
            Compute value estimates Vλ (sτ ) via Equation 6.
                                   Pt+H                             Imagination horizon                                                                          H
            Update φ ← φ + α∇φ τ =t Vλ (sτ ).
                                    Pt+H 1                        2 Learning rate                                                                                α
            Update ψ ← ψ − α∇ψ τ =t 2 vψ (sτ )9Vλ (sτ ) .
...
    Published as a conference paper at ICLR 2020
                         ...
                         Cartpole Swingup                        Cheetah Run                     Quadruped Walk                            Walker Walk
                 1000                               1000                                  1000                              1000
                 800                                 800                                   800                              800
...
Episode Return
    ...
    model estimates the expected imagined rewards that the action model achieves from each state sτ ,
                                  ...
                                  Action model:                                      aτ ∼ qφ (aτ | sτ )
                                                                                                               Pt+H          τ −t
                                                                                                                                                           (2)
                                  Value model:                                       vψ (sτ ) ≈ Eq(·|sτ )         τ =t γ            rτ .
   ...
   network output, allowing us to backpropagate analytic gradients through the sampling operation,
    ...
    ways that trade off bias and variance (Sutton and Barto, 2018),
                        ...
                        VR (sτ ) = Eqθ ,qφ                 rn ,                                                                                             (4)
                         ...
                         k       .                X
                                                               n−τ            h−τ
                        VN (sτ ) = Eqθ ,qφ                 γ         rn + γ          vψ (sh )  with h = min(τ + k, t + H),                                  (5)
                                                     n=τ
                                                    H−1
                                 .         X
                        Vλ (sτ ) = (1 − λ)   λn−1 VN
    ...
    from τ until the horizon and ignores rewards beyond it. This allows learning the action model without
                                                                        k
    a value model, an ablation we compare to in our experiments. VN       estimates rewards beyond k steps
...
Model True Model True
       ...
       value model vψ (sτ ), in turn, is to regress the value estimates,
                          t+H                                         t+H                            
                            X                                            X1                           2
            max Eqθ ,qφ          Vλ (sτ ) ,    (7)         min Eqθ ,qφ           vψ (sτ ) − Vλ (sτ ))     .    (8)
              φ
                            τ =t
                                                            ψ
                                                                         τ =t
       ...
       the imagined Pactions. Since all steps are implemented as neural networks, we analytically compute
                      t+H
       ∇φ Eqθ ,qφ     τ =t Vλ (sτ ) by stochastic backpropagation (Kingma and Welling, 2013; Rezende
...
Episode Return
   ...
   rewards and a KL regularizer. The expectation is taken under the dataset and representation model,
                     X                       
                .                                                   .
         JREC = Ep            JOt + JRt + JDt     + const      JOt = ln q(ot | st )
                         t                                                                          (10)
             .                        .
         JRt = ln q(rt | st )    JDt = −β KL p(st | st−1 , at−1 , ot ) q(st | st−1 , at−1 ) .
                                                                                             
    ...
    over observations o0 of the current
                                     Psequence batch. Intuitively, q(st | ot ) makes the state predictable
    from the current image while ln o0 q(st | o0 ) keeps it diverse to prevent collapse,
                     X                                                 X               
                .              t      t   t         t .                                   0
         JNCE = E            JS + JR + JD         JS = ln q(st | ot ) − ln        q(st | o ) .        (12)
                                     t                                                            o0
...
    Published as a conference paper at ICLR 2020
                             ...
                             Acrobot Swingup                  Cartpole Swingup Sparse                        Hopper Hop                              Hopper Stand
                                                                                                                                       1000
                 400                                   800                                      400
                                                                                                                                       750
                 ...
                 100                                   200                                                                             250
                   0                                     0                                        0                                       0
                       0.0    0.5   1.0   1.5   2.0          0.0   0.5    1.0     1.5    2.0          0.0   0.5   1.0     1.5    2.0          0.0   0.5   1.0   1.5   2.0
                             Pendulum Swingup                      Quadruped Walk                            Walker Run                              Walker Walk
                                                      1000                                                                             1000
                                                                                                800
                 750
                                                       750                                                                             750
...
We define the information bottleneck objective (Tishby et al., 2000) for latent dynamics models,
                           max I(s1:T ; (o1:T , r1:T ) | a1:T ) − β I(s1:T , i1:T | a1:T ),         (13)
                                                                                         .
where β is scalar and it are dataset indices that determine the observations p(ot | it ) = δ(ot − ōt ) as
in Alemi et al. (2016).
...
divergence and drop the marginal data probability as it does not depend on the representation model,
  I(s1:T ; (o1:T , r1:T ) | a1:T )
                              X                                                                
= Ep(o1:T ,r1:T ,s1:T ,a1:T )      ln p(o1:T , r1:T | s1:T , a1:T ) − ln p(o1:T , r1:T | a1:T )
                                  t                                                   const
      X                                         
+
= E           ln p(o1:T , r1:T | s1:T , a1:T )
         t
      X                                                                                    Y                           
≥ E           ln p(o1:T , r1:T | s1:T , a1:T ) − KL p(o1:T , r1:T | s1:T , a1:T )                   q(ot | st )q(rt | st )
         t                                                                                      t
      X                                     
...
variational encoder, apply Bayes rule, and use the InfoNCE mini-batch bound (Poole et al., 2019),
                       ...
                       = E ln q(ot | st ) − ln q(ot ) + ln q(rt | st )
                                                                      
                       = E ln q(st | ot ) − ln q(st ) + ln q(rt | st )                        (15)
                                                X                               
                       ≥ E ln q(st | ot ) − ln       q(st | o0 ) + ln q(rt | st ) .
                                                             o0

For the second term, we use the non-negativity of the KL divergence to obtain an upper bound,
             I(s1:T ; i1:T | a1:T )
                                             X                                                               
       = Ep(o1:T ,r1:T ,s1:T ,a1:T ,i1:T )           ln p(st | st−1 , at−1 , it ) − ln p(st | st−1 , at−1 )
                                              t
               X                                                            
       = E             ln p(st | st−1 , at−1 , ot ) − ln p(st | st−1 , at−1 )
                   t                                                                                                (16)
               X                                                            
       ≤ E             ln p(st | st−1 , at−1 , ot ) − ln q(st | st−1 , at−1 )
                   t
               X                                                              
       = E             KL p(st | st−1 , at−1 , ot )        q(st | st−1 , at−1 ) .
                   t
...
Episode Return
                 ...
                 100000                                                                                   5.0                                           20
                  ...
                  50000                                            5000                                   2.5
                                                                                                          0.0                                           0
                             0                                         0
                                      2        4       6                    0.5    1.0     1.5                   0.25 0.50 0.75 1.00 1.25 1.50                   1 2 3 4 5
...
G     C ONTINUOUS C ONTROL S CORES
...
Average                                                     243.70         786.32         332.97         823.39
   ...
   1
     We re-run PlaNet with fixed action repeat of R = 2 to not tune the this value for each of the 20 tasks. As a
